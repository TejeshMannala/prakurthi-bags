      ...
      <div className="min-h-screen bg-gradient-to-br from-[#F9F9F6] via-white to-[#f0f7f1]">
        <div className="max-w-3xl mx-auto px-6 py-20">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center py-20">
            ...
            <h2 className="text-2xl font-bold text-gray-800 font-serif mb-3">Return Policy</h2>
            <p className="text-gray-400 max-w-md mx-auto mb-8">Return policy information is not available yet. Please check back later or contact our support team for assistance.</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F9F9F6] via-white to-[#f0f7f1]">
      <section className="relative overflow-hidden bg-gradient-to-br from-[#0f1a0f] via-[#1a2a1a] to-[#0d1f0d] py-20 lg:py-28">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mt-8">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-white font-serif mb-4">{policy.title || 'Return Policy'}</h1>
            {policy.createdAt && (
      ...
      <section className="max-w-4xl mx-auto px-6 -mt-16 relative z-20 pb-20">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}
          ...
          <p className="text-[#2E5A44] text-sm font-medium">Have questions about returns?</p>
