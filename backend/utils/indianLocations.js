...
const majorCitiesByDistrict = {
  ...
  'vijayawada': ['Vijayawada', 'Mangalagiri', 'Tadepalligudem', 'Nuzvid', 'Gannavaram', 'Gudivada'],
  'Guntur': ['Guntur', 'Tenali', 'Ponnur', 'Macherla', 'Narasaraopet'],
  'Tirupati': ['Tirupati', 'Srikalahasti', 'Chittoor', 'Puttur'],
  'Coimbatore': ['Coimbatore', 'Peelamedu', 'RS Puram', 'Singanallur', 'Kovaipudur'],
  'Madurai': ['Madurai', 'Thirumangalam', 'Melur', 'Usilampatti'],
  'Tiruchirappalli': ['Tiruchirappalli', 'Srirangam', 'Thuraiyur', 'Lalgudi'],
  'Salem': ['Salem', 'Attur', 'Omalur', 'Mettur'],
  'Tirunelveli': ['Tirunelveli', 'Palayamkottai', 'Ambasamudram', 'Nanguneri'],
  'Thiruvananthapuram': ['Thiruvananthapuram', 'Kowdiar', 'Vazhuthacaud', 'Pattom', 'Kazhakuttam'],
  'Kochi': ['Kochi', 'Ernakulam', 'Fort Kochi', 'Mattancherry', 'Vyttila'],
  'Kozhikode': ['Kozhikode', 'Calicut', 'Feroke', 'Kunnamangalam'],
  'Thrissur': ['Thrissur', 'Guruvayur', 'Chavakkad', 'Kodungallur'],
  'Kannur': ['Kannur', 'Taliparamba', 'Payyannur', 'Thalassery'],
  'Kollam': ['Kollam', 'Karunagappally', 'Paravur', 'Punalur'],
  'Bhubaneswar': ['Bhubaneswar', 'Cuttack', 'Puri', 'Rourkela'],
  'Ranchi': ['Ranchi', 'Jamshedpur', 'Dhanbad', 'Bokaro'],
  'Patna': ['Patna', 'Gaya', 'Bhagalpur', 'Muzaffarpur'],
  'Guwahati': ['Guwahati', 'Silchar', 'Dibrugarh', 'Jorhat'],
  'Imphal': ['Imphal', 'Thoubal', 'Churachandpur', 'Bishnupur'],
  'Shillong': ['Shillong', 'Tura', 'Jowai', 'Nongstoin'],
  'Aizawl': ['Aizawl', 'Lunglei', 'Champhai', 'Serchhip'],
  'Kohima': ['Kohima', 'Mokokchung', 'Tuensang', 'Wokha'],
  'Agartala': ['Agartala', 'Udaipur', 'Dharmanagar', 'Kailashahar'],
  'Gangtok': ['Gangtok', 'Namchi', 'Mangan', 'Gyalshing'],
  'Itanagar': ['Itanagar', 'Pasighat', 'Ziro', 'Bomdila'],
  'Dispur': ['Dispur', 'Nagaon', 'Tezpur', 'Dibrugarh'],
  'Shimla': ['Shimla', 'Solan', 'Kullu', 'Mandi'],
  'Dehradun': ['Dehradun', 'Haridwar', 'Rishikesh', 'Mussoorie'],
  'Leh': ['Leh', 'Kargil'],
  'Kavaratti': ['Kavaratti', 'Agatti', 'Minicoy', 'Kalpeni'],
  'Port Blair': ['Port Blair', 'Havelock Island', 'Neil Island'],
};
...
const getStateFromPincode = (pincode) => {
  ...
  const stateMap = {
    ...
    10: ['Maharashtra', 'Madhya Pradesh', 'Chhattisgarh'],
    11: ['Andhra Pradesh', 'Karnataka', 'Telangana', 'Tamil Nadu', 'Kerala', 'Puducherry', 'Lakshadweep'],
  };
